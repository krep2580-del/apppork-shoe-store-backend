...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When using the native "file" session driver, we need a location where session
    ...
    */
    ...
    | for you; however, you are free to change this table name.
    |
    */
    ...
    */
    ...
    | will set this value to "lax" because this is a secure default value.
    |
